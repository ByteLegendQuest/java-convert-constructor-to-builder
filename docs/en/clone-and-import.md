...
`git clone https://github.com/ByteLegendQuest/java-convert-constructor-to-builder`

A project directory named `java-convert-constructor-to-builder` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-convert-constructor-to-builder` directory which is created just now.
